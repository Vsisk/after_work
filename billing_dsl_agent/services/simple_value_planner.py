...
class SimpleValuePlanner:
    ...
    def build_plan(self, intent: NodeIntent, binding: ResourceBinding, env: ResolvedEnvironment) -> ValuePlan:
        ...
        wrapped_expr = self._wrap_function_if_needed(base_expr=base_expr, binding=binding, env=env)
    ...
    def _wrap_function_if_needed(self, base_expr: ExprNode, binding: ResourceBinding, env: ResolvedEnvironment) -> ExprNode:
